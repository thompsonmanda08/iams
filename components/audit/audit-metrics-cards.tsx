...
export function AuditMetricsCards({ metrics, isLoading }: AuditMetricsCardsProps) {
  ...
  const metricCards = [
    {
      title: "Total Audits",
      value: metrics.total_audit_count,
      subtitle: `${metrics.approved_audit_count} in progress`,
      icon: FileText,
    ...
    },
    {
      ...
      value: metrics.approved_audit_count,
      subtitle: `${metrics.approved_audit_count} critical`,
      icon: AlertCircle,
    ...
    },
    {
      ...
      value: metrics.upcoming_audit_count,
