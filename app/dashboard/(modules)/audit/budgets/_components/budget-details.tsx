...
import { BudgetItem } from "@/lib/types/audit-types";
import { mockBudgetItems, mockBudgets } from "./budget-form";
...
const BudgetDetails = () => {
  ...
  const budgetLine = budget?.budget_lines.find((line) => line.id === lineID);
  const items = mockBudgetItems.filter((item) => item.budget_line_id === lineID);
  ...
  return (
    <>
      {/* Header */}
      <div className="animate-slide-up mb-8 flex items-center justify-end">
        {!showItemForm && (
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className="animate-fade-in p-6 shadow-xl [animation-delay:100ms]">
          <div className="mb-6 flex items-center gap-3 border-b pb-4">
            ...
            <div>
              <h2 className="text-foreground text-xl font-bold">Budget Line: {budgetLine.name}</h2>
          ...
          <form onSubmit={handleSubmitItem}>
            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="itemName" className="flex items-center gap-2 text-sm font-semibold">
