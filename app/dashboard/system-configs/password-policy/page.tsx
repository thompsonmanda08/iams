      ...
      <div className="bg-card border-b">
        <div className="container mx-auto px-4 py-6">
          <PageHeader
            ...
            description="Configure password requirements, security rules, and authentication settings"
            Icon={SquareAsterisk}
          />
        </div>
      </div>
            ...
            <div className="space-y-6 lg:col-span-2">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between rounded-lg border p-3">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handlePolicyChange("require_uppercase", checked)
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between rounded-lg border p-3">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handlePolicyChange("require_lowercase", checked)
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between rounded-lg border p-3">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handlePolicyChange("require_numbers", checked)
                          }
                        />
                      </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure account lockout and authentication rules
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  {/* Max Failed Attempts */}
                  ...
                  {/* Lockout Duration */}
                  <div className="space-y-2">
                    <Label htmlFor="lockout_duration_mins">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-muted-foreground text-xs">
                      Sessions will be automatically logged out after {policy.session_timeout_mins}{" "}
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handlePolicyChange("otp_expiry_mins", parseInt(e.target.value))
                      }
                      className="max-w-xs"
                    />
                    <p className="text-muted-foreground text-xs">
              ...
              <Card className="bg-muted/30">
                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono font-medium">
                      {policy.lockout_duration_mins} mins
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Session Timeout:</span>
                    <span className="font-mono font-medium">
                      {policy.session_timeout_mins} mins
                    </span>
                  </div>
                  <div className="flex justify-between">
